...
$page_title = "Game_Zone";
 ...
 ?>
    ...
    <div id="main_content">
	<div align="left">
  <span style="color: rgb(0, 0, 128);"><span style="font-size: large;"><a href="game_zone.php">Game Zone:</a></span></span></div>
  <hr  />  
  <p><br></p>
...
Microsoft ® Encarta ® 2009. © 1993-2008 Microsoft Corporation. All rights reserved.        </p>
    ...
    <div id="right_bar">
      ...
      <div id="sub_menu">
    <ul>
    <li id="sub_menu_lab"><a href="game_reviews.php"><img src="images/game.png" alt="Game Reviews" /></a></li>
    
    <li id="sub_menu_abt"><a href="new_games.php"><img src="images/new_games.png" alt="New Games" /></a></li>
    <li id="sub_menu_abt"><a href="top_ten.php"><img src="images/top.png" alt="Top Ten Games" /></a></li>
    </ul>
   </div>
   <p>
      </p>
