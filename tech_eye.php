...
Microsoft ® Encarta ® 2009. © 1993-2008 Microsoft Corporation. All rights reserved.        </p>
    ...
    <div id="right_bar">
      ...
      <div id="sub_menu">
    <ul>
    <li id="sub_menu_lab"><a href="articles.php"><img src="images/articles.png" alt="Articles" /></a></li>
    
    <li id="sub_menu_abt"><a href="article_submission.php"><img src="images/submit_article.png" alt="Submit Article" /></a></li>
    </ul>
   </div>
   <p>
      </p>
