...
Microsoft ® Encarta ® 2009. © 1993-2008 Microsoft Corporation. All rights reserved.        </p>
    </div>
    <div id="right_bar">
      
      <div id="sub_menu">
    <ul>
    <li id="sub_menu_lab"><a href="lab_work_in_C.php"><img src="images/c.png" alt="C or C++" /></a></li>
    <li id="sub_menu_lab"><a href="lab_work_in_PHP.php"><img src="images/php.png" alt="PHP" /></a></li>
    <li id="sub_menu_lab"><a href="lab_work_in_Java.php"><img src="images/java.png" alt="Java" /></a></li>
    <li id="sub_menu_lab"><a href="lab_work_in_Python.php"><img src="images/Python.png" alt="Python" /></a></li>
    </ul>
   </div>
   <p>
      </p>
